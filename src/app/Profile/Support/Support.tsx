...
import { ArrowLeft2, ArrowRight, Whatsapp } from "@wandersonalwes/iconsax-react";
      ...
      <div className={styles.main}>
        ...
        <div className={styles.cardSelected}>
          ...
          <div className={styles.text}>
            به تب خانه بروید. روی دکمه + ثبت تشنج کلیک کنید. جزئیات مربوط به تشنج (تاریخ، مدت زمان، علائم و هر اطلاعات دیگر) را
            وارد کنید.روی گزینه ذخیره بزنید. تمام اطلاعات شما به صورت خودکار ذخیره و در تب گزارش‌ها قابل مشاهده است.
          </div>
        </div>
