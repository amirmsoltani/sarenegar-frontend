...
import { ArrowRight, Profile, ArrowLeft2, Lifebuoy, Logout } from "@wandersonalwes/iconsax-react";
      ...
      <div className={styles.main}>
        <div className={styles.row}>
          <div className={styles.col}>
            ...
            <Link className={styles.link} to={`/${RouterService.params.date}/info`}>
        ...
        <div className={styles.row}>
          <div className={styles.col}>
            ...
            <Link className={styles.link} to={`/${RouterService.params.date}/support`}>
              <ArrowLeft2 className={styles.icon} />
            </Link>
          </div>
