...
export type TUseForm<T extends FieldValues> = Pick<TForm<T>, "onSubmit" | "onError" | "handleSubmit">;
...
export type TOnChangeReturn<T> = { value: T; isValid?: never } | { value?: never; isValid: boolean };
